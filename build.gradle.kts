...
dependencies {
    ...
    modRuntimeOnly ("dev.onyxstudios.cardinal-components-api:cardinal-components-item:${providers.gradleProperty("cca_version").get()}")
    modRuntimeOnly ("dev.onyxstudios.cardinal-components-api:cardinal-components-block:${providers.gradleProperty("cca_version").get()}")
    modRuntimeOnly ("at.petra-k:paucal:${providers.gradleProperty("paucal_version").get()}")
    modRuntimeOnly ("me.shedaniel.cloth:cloth-config-fabric:${providers.gradleProperty("cloth_config_version").get()}")
    modRuntimeOnly ("vazkii.patchouli:Patchouli:${providers.gradleProperty("patchouli_version").get()}")
    modRuntimeOnly ("com.samsthenerd.inline:${providers.gradleProperty("inline_version").get()}")
